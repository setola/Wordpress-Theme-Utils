...
wp_register_style('front-page', get_template_directory_uri().'/css/front-page.css', array('open-sans-cl', 'fbqs', 'offers'), '0.1', 'screen');
...
/**
 * Replace symlinked files or w3tc will blow up.
 */
if(!is_admin()){
